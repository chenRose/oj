...
int LANG_PV[256] = {0,1,2,3,4,9,11,13,16,59,89,97,201,231,SYS_open, SYS_set_thread_area, SYS_brk, SYS_read,
		...
		SYS_exit_group, SYS_munmap, SYS_time, 4, -1 };
//java
int LANG_JV[256] = { 0,2,3,4,5,9,10,11,12,13,14,21,56,59,89,97,104,158,202,218,231,273,257, 
		...
		SYS_set_tid_address, SYS_set_robust_list, SYS_exit_group, 158, -1 };
//ruby
int LANG_RV[256] = { 0,1,2,3,4,5,9,10,12,13,14,16,21,22,56,59,72,97,98,107,108,131,158,202,218,231,273
		...
		SYS_set_tid_address, SYS_write, -1 };
//bash
int LANG_BV[256] = { 0,1,2,3,4,5,8,9,10,12,13,14,16,21,33,39,59,63,72,79,97,99,102,104,107,108,110,111,158,231,
		...
		SYS_stat, SYS_uname, SYS_write, 14, -1 };
//python
...
int LANG_PLV[256] = {0,1,2,3,4,5,8,9,10,12,13,14,16,21,59,72,89,97,102,104,107,108,158,202,218,231,273,
		...
		SYS_time, SYS_uname, SYS_write, -1 };
//c-sharp
int LANG_CSV[256] = {0,1,2,3,4,5,8,9,10,11,12,13,14,16,21,24,41,42,56,59,63,72,78,79,89,97
		...
		SYS_statfs, SYS_tgkill, SYS_time, SYS_uname, SYS_unlink, SYS_write, -1 };
//objective-c
...
int LANG_BASICV[256] = { 0,1,2,3,4,5,9,10,12,13,14,16,21,59,97,158,173,202,218,231,273,
		...
		SYS_set_tid_address, SYS_stat, SYS_uname, SYS_write, -1};
//scheme
int LANG_SV[256] = { 1, 23, 100, 61, 22, 6, 33, 8, 13, 16, 111, 110, 39, 79,
		...
		SYS_exit_group, 158, -1 };
//lua
int LANG_LUAV[256]={0,1,2,3,4,5,9,10,11,12,13,21,59,158,231,292,-1};
//nodejs javascript
int LANG_JSV[256]={0,1,2,3,4,5,6,9,10,11,12,13,14,16,21,56,59,79,89,96,97,158,186,202,218,228,231,232,233,273,290,291,293,-1};
//go-lang
int LANG_GOV[256]={0,1,9,11,13,14,56,59,131,158,202,204,228,231,-1};
